...
export default function AddTraining() {
  ...
  const hasAtLeastOneParticipant = participants.some(isParticipantComplete);
  ...
  const handleParticipantChange = (index, field, value) => {
    ...
    setParticipants((prev) =>
      prev.map((participant, i) =>
        i === index ? { ...participant, [field]: nextValue } : participant
      )
    );
  };
  ...
  const addParticipant = () => {
    setParticipants((prev) => [
      ...prev,
      { fullName: "", aadhaarNumber: "", email: "", phone: "" },
    ]);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!hasAtLeastOneParticipant) {
      setError(
        "Please add at least one participant with all fields filled: valid name, 12-digit Aadhaar, valid email, and 10-digit phone."
      );
      return;
    }

    if (!participants.every(isParticipantComplete)) {
      setError(
        "Each participant must have all fields valid: full name, 12-digit Aadhaar, valid email format, and 10-digit phone number."
      );
      return;
    }
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className={styles["form-row"]}>
                    ...
                    <div className={styles["form-group"]}>
                      ...
                      >
                        ...
                        <option value="Cyclone Management">Cyclone Management</option>
                ...
                <div className={styles["form-section"]}>
                  ...
                  <p className={styles["section-subtitle"]}>
                    Add participant details. Fill one participant to enable
                    adding another.
                  </p>
                  ...
                  <div className={styles["participants-list"]}>
                    {participants.map((participant, index) => (
                      <div
                        ...
                        className={styles["participant-card"]}
                      >
                        <div className={styles["participant-header"]}>
                          <span>Participant {index + 1}</span>
                          {participants.length > 1 && (
                            <button
                              type="button"
                              className={styles["remove-participant-btn"]}
                        ...
                        <div className={styles["participant-grid"]}>
                          ...
                          <div className={styles["form-group"]}>
                            ...
                            <input
                              type="text"
                              value={participant.aadhaarNumber}
                              onChange={(e) =>
                                handleParticipantChange(
                                  index,
                                  "aadhaarNumber",
                ...
                <div className={styles["form-actions"]}>
                  ...
                  <button
                    ...
                    disabled={loading || uploadingPhotos || !hasAtLeastOneParticipant}
                  >
                    {loading
                      ? "Submitting..."
                      : uploadingPhotos
