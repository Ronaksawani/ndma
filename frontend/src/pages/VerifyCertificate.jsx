      ...
      <div className={styles.container}>
        <section className={styles.hero}>
          ...
          <p className={styles.subtitle}>
            Verify the authenticity of disaster management training certificates
            issued through this portal
          </p>
        </section>
            ...
            {result && (
              <div className={styles["result-card"]}>
                ...
                <div className={styles["result-details"]}>
                  ...
                  >
                    <h4 style={{ margin: 0 }}>
                      Certificates found: {result.certificates.length}
                    </h4>
                ...
                <div className={styles["result-footer"]}>
                  <p>
                    This certificate is valid and issued by NDMA Training
                    Portal.
                    <br />
            ...
            <div className={styles["info-grid"]}>
              <div className={styles["info-card"]}>
                ...
                <p>
                  ...
                  certificates issued by organizations registered with our
                  portal.
                </p>
              </div>
              <div className={styles["info-card"]}>
                ...
                <p>
                  Enter your 12-digit Aadhaar number as mentioned in your
                  training certificate. Our system will verify the certificate
              ...
              <div className={styles["info-card"]}>
                <h4>Why verify?</h4>
                <p>
                  Verification ensures that the certificate is legitimate and
                  issued by a registered training partner approved by NDMA.
                </p>
              </div>
              <div className={styles["info-card"]}>
                <h4>Need help?</h4>
                <p>
                  If you have questions about your certificate, contact the
                  issuing organization directly or reach out to our support
                  team.
                </p>
              </div>
            </div>
