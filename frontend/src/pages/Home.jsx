      ...
      <div className={styles["home-container"]}>
          ...
          <div className={styles["counters-wrapper"]}>
            <div className={styles["counter-card"]}>
              ...
              <div className={styles["counter-text"]}>
                <div className={styles["counter-label"]}>Total Volunteers Trained</div>
            ...
            <div className={styles["counter-card"]}>
              <div className={styles["counter-icon"]}>📚</div>
              <div className={styles["counter-text"]}>
                <div className={styles["counter-label"]}>Trainings Conducted</div>
                <div className={styles["counter-number"]}>
            ...
            <div className={styles["counter-card"]}>
              ...
              <div className={styles["counter-text"]}>
                ...
                <div className={styles["counter-number"]}>{counters.states}</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={styles["preparedness-section"]}>
          <div className={styles["preparedness-wrapper"]}>
            <h2 className={styles["section-title"]}>Disaster Preparedness & Safety</h2>
            <div className={styles["disaster-grid"]}>
              {/* Earthquakes */}
              <div className={styles["disaster-card"]}>
                <div className={styles["disaster-image"]}>
                  <img src="/images/earthquake.png" alt="Earthquakes" className={styles["disaster-img"]} />
                </div>
                ...
                <div className={styles["disaster-content"]}>
                  <div className={styles["do-section"]}>
                    <div className={styles["tip-item"]}>
                      ...
                      <span>Repair deep plaster cracks in ceilings and foundations. Get expert advice if there are signs of structural defects.</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Anchor overhead lighting fixtures to the ceiling.</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Follow BIS codes relevant to your area for building standards</span>
                    </div>
                  </div>
              ...
              <div className={styles["disaster-card"]}>
                <div className={styles["disaster-image"]}>
                  <img src="/images/landslide.png" alt="Landslide" className={styles["disaster-img"]} />
                </div>
                ...
                <div className={styles["disaster-content"]}>
                  <div className={styles["do-section"]}>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Prepare tour to hilly region according to information given by weather department or news channel.</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Move away from landslide path or downstream valleys quickly without wasting time.</span>
                    </div>
                  </div>
                  <div className={styles["divider"]}></div>
                  <div className={styles["dont-section"]}>
                    <div className={styles["tip-item"]}>
                      <span className={styles["cross-icon"]}>✕</span>
                      <span>Try to avoid construction and staying in vulnerable areas.</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["cross-icon"]}>✕</span>
              ...
              <div className={styles["disaster-card"]}>
                <div className={styles["disaster-image"]}>
                  <img src="/images/flood.png" alt="Tsunami" className={styles["disaster-img"]} />
                </div>
                ...
                <div className={styles["disaster-content"]}>
                  <div className={styles["do-section"]}>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Know the height of your street above sea level and the distance of your street from the coast or other high-risk waters.</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Plan evacuation routes from your home, school, workplace, or any other place you could be where tsunamis present a risk</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                  ...
                  <div className={styles["dont-section"]}>
                    <div className={styles["tip-item"]}>
                      <span className={styles["cross-icon"]}>✕</span>
                      <span>Move immediately to higher ground, DO NOT wait for a tsunami warning to be announced.</span>
                    </div>
                  </div>
                </div>
                <button className={styles["view-more-btn"]}>View More +</button>
              ...
              <div className={styles["disaster-card"]}>
                <div className={styles["disaster-image"]}>
                  <img src="/images/cyclone.png" alt="Cyclone" className={styles["disaster-img"]} />
                </div>
                ...
                <div className={styles["disaster-content"]}>
                  <div className={styles["do-section"]}>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Check the house; secure loose tiles and carry out repairs of doors and windows.</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Keep some wooden boards ready so that glass windows can be boarded if needed</span>
                    </div>
                    <div className={styles["tip-item"]}>
                      <span className={styles["check-icon"]}>✓</span>
                      <span>Keep a hurricane lantern filled with kerosene, battery operated torches and enough dry cells</span>
                    </div>
                  </div>
                  <div className={styles["divider"]}></div>
                  <div className={styles["dont-section"]}>
                    <div className={styles["tip-item"]}>
                      <span className={styles["cross-icon"]}>✕</span>
                      <span>DO NOT venture out even when the winds appear to calm down.</span>
                    </div>
                  </div>
                </div>
                <button className={styles["view-more-btn"]}>View More +</button>
          ...
          <div className={styles["news-wrapper"]}>
            ...
            <div className={styles["news-list"]}>
              <div className={styles["news-item"]}>
                <div className={styles["news-item-content"]}>
                  <h4 className={styles["news-item-title"]}>
                    Press Release - Five Regional Metter in india latt NDMA, Disaster Management Training Portal another
                  </h4>
                  <p className={styles["news-item-date"]}>Feb 21, 2022, 10:45 pm</p>
                </div>
              </div>
              ...
              <div className={styles["news-item"]}>
                <div className={styles["news-item-content"]}>
                  <h4 className={styles["news-item-title"]}>
                    Press Release - Firelest Week to Fire Kahugar India Management NDMA Disaster Management Training Portal
                  </h4>
                  <p className={styles["news-item-date"]}>Feb 21, 2022, 12:33 am</p>
                </div>
              </div>
              ...
              <div className={styles["news-item"]}>
                <div className={styles["news-item-content"]}>
                  <h4 className={styles["news-item-title"]}>
                    Press Release - Tomittar rumash-in NDMA Disaster Management Training Portal im pis coSInity
                  </h4>
                  <p className={styles["news-item-date"]}>Feb 21, 2022, 11:55 pm</p>
                </div>
              </div>
            </div>
            <div className={styles["news-footer"]}>
              <button className={styles["show-more-btn"]} onClick={() => navigate("/resources")}>
                Show More
              </button>
            </div>
          </div>
            ...
            <div className={styles["social-wrapper"]}>
              ...
              <div className={styles["social-grid"]}>
                ...
                >
                  ...
                  <p className={styles["social-follow-text"]}>Follow NDMA on Facebook</p>
                </a>
                ...
                >
                  ...
                  <p className={styles["social-follow-text"]}>Subscribe to NDMA YouTube</p>
                </a>
                ...
                >
                  ...
                  <p className={styles["social-follow-text"]}>Follow NDMA on LinkedIn</p>
                </a>
              </div>
            </div>
          </section>
        ...
        <section className={styles["cta-section"]}>
          <div className={styles["cta-wrapper"]}>
            ...
            <p className={styles["cta-subtitle"]}>
              Join thousands of organizations building disaster resilience across India
            </p>
        ...
        <footer className={styles["home-footer"]}>
          <div className={styles["footer-content"]}>
            <div className={styles["footer-section"]}>
              ...
              <ul className={styles["footer-list"]}>
                ...
                <li>
                  <a href="https://mha.gov.in" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles["footer-bottom"]}>
            <p className={styles["footer-copyright"]}>
              © 2024 National Disaster Management Authority (NDMA). All rights reserved.
            </p>
